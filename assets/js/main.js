        ...
        input.addEventListener('change', function () {
            ...
            if (file && file.type.startsWith('image/')) {
                ...
                reader.onload = function (e) {
                    ...
                    preview.innerHTML = '<img src="' + e.target.result + '" style="max-width:200px;border-radius:8px;border:1px solid #E0E0E0;">';
...
function togglePassword(inputId) {
    ...
    const icon = input.nextElementSibling ? input.parentElement.querySelector('.password-toggle i') : null;
